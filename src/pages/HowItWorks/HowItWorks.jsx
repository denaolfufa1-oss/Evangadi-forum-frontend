      ...
      <div className={styles.container}>
        <div className={styles.inner_container}>
          ...
          <p className={styles.description}>
            ...
            students by enabling them to ask questions. It creates an
            interactive platform where students can share knowledge, support
            each other, and enhance their understanding through discussion.
          </p>
